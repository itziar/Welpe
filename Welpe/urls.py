...
urlpatterns += [
    ...
    url('^informacion', include('Welpe.infoInteres.urls')),
    url('^foro', include('Welpe.foro.urls')),
    url('^propuestas', include('Welpe.propuestas.urls')),
    url("^$", include('Welpe.theme.urls')),
    #url("^$", direct_to_template, {"template": "index.html"}, name="home"),
